...
class WebscrapingSpider(scrapy.Spider):
  ...
  def parseTribuneBusiness(self, response):
    ...
    items["image"] = response.css('div.story-box-section div.mainstorycontent-parent div.storypage-main-section2 div.storypage-rightside span.top-big-img div.story-featuredimage div.amp-top-main-img div.featured-image-global img::attr(data-src)').get()
